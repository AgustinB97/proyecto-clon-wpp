                ...
                {filteredContacts.map((contact) => {
                    ...
                    return (
                        <li
                            ...
                            style={{ backgroundColor: selectContactId === contact.id ? '#ebe6e6ff' : undefined }}
                        >
                            <div className="contact-preview__avatar-container">
                                <img className="contact-preview__avatar" src={contact.avatar} alt={contact.name} />
                            </div>
                            ...
                            <div className="contact-preview__text">
                                <div className="contact-preview__name-hour">
                                    ...
                                    <span className="contact-preview__hour">{last.hour}</span>
                                </div>
                                <span className="contact-preview__last-message">{last.message}</span>
                            </div>
                        </li>
                    );
